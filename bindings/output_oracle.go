...
//
// Solidity: function initialize(bytes32 _configHash) returns()
func (_OutputOracle *OutputOracleTransactor) Initialize(opts *bind.TransactOpts, _configHash [32]byte) (*types.Transaction, error) {
	return _OutputOracle.contract.Transact(opts, "initialize", _configHash)
}

// Initialize is a paid mutator transaction binding the contract method 0x9498bd71.
//
// Solidity: function initialize(bytes32 _configHash) returns()
func (_OutputOracle *OutputOracleSession) Initialize(_configHash [32]byte) (*types.Transaction, error) {
	return _OutputOracle.Contract.Initialize(&_OutputOracle.TransactOpts, _configHash)
}

// Initialize is a paid mutator transaction binding the contract method 0x9498bd71.
//
// Solidity: function initialize(bytes32 _configHash) returns()
func (_OutputOracle *OutputOracleTransactorSession) Initialize(_configHash [32]byte) (*types.Transaction, error) {
	return _OutputOracle.Contract.Initialize(&_OutputOracle.TransactOpts, _configHash)
}
