...
type BatcherService struct {
	...
	ChannelConfig batcher.ChannelConfigProvider
	RollupConfig  *rollup.Config

	driver *batcher.BatchSubmitter
...
func BatcherServiceFromCLIConfig(ctx context.Context, version string, cfg *batcher.CLIConfig, log log.Logger) (*BatcherService, error) {
...
func (bs *BatcherService) initFromCLIConfig(ctx context.Context, version string, cfg *batcher.CLIConfig, log log.Logger) error {
	bs.Version = version
	bs.Log = log
...
func (bs *BatcherService) initRPCClients(ctx context.Context, cfg *batcher.CLIConfig) error {
...
func (bs *BatcherService) initMetrics(cfg *batcher.CLIConfig) {
...
func (bs *BatcherService) initChannelConfig(cfg *batcher.CLIConfig) error {
	...
	if cfg.DataAvailabilityType == flags.AutoType {
		...
		bs.ChannelConfig = batcher.NewDynamicEthChannelConfig(bs.Log, 10*time.Second, bs.TxManager, cc, calldataCC)
	} else {
		bs.ChannelConfig = cc
	}
...
func (bs *BatcherService) initPProf(cfg *batcher.CLIConfig) error {
...
func (bs *BatcherService) initMetricsServer(cfg *batcher.CLIConfig) error {
	if !cfg.MetricsConfig.Enabled {
...
func (bs *BatcherService) initRPCServer(cfg *batcher.CLIConfig) error {
